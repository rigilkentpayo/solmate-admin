...
// Email allow-list + RTDB role check
const ADMIN_EMAILS = ["admin@solmate.com", "queenelynalunan0@gmail.com"];

// Prefix for GitHub Pages repo path
const ASSET_PREFIX = process.env.NODE_ENV === "production" ? "/solmate-admin" : "";
                ...
                <div className="grid min-h-screen place-items-center px-6">
                    <div className="max-w-lg rounded-2xl border border-white/10 bg-white/10 p-6 text-slate-100 backdrop-blur-md shadow-2xl space-y-4">
                        <div className="flex items-center gap-3">
                            <Image
                                src={`${ASSET_PREFIX}/solmate-logo.png`}
                                alt="SolMate Logo"
                                width={40}
                                height={40}
